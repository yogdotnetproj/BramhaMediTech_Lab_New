 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="OperatorwiseSummary_Old.aspx.cs" Inherits="OperatorwiseSummary" %>
...
<head id="Head1" runat="server">
        ...
        <title>Operator wise Cash summery  </title>
     ...
     <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>Operator wise Cash summery</h1>
                    <ol class="breadcrumb">
                    <li><a href="Login.aspx"><i class="fa fa-fw fa-lock"></i> Login</a></li>
                       <li><a href="Login.aspx"><i class="fa fa-fw fa-power-off"></i> Log out</a></li>
                        ...
                        <li class="active">Operator wise Cash summery </li>
                    </ol>
                </section>
                <!-- Main content -->
...
<asp:button id="btnlist" runat="server" OnClientClick="return validate();" onclick="btnlist_Click" text="Click" Visible="false" class="btn btn-primary" />
                                        <asp:button id="btnreport" OnClientClick="return validate();" runat="server" class="btn btn-primary" onclick="btnreport_Click"
