...
public partial class Phlebotomist2wayAccept : System.Web.UI.Page
{
    ...
    string Barcode_ID = "", OutNewBarcode="";
        ...
        if (!IsPostBack)
        {
            try
            {
                if (Convert.ToString(Session["HMS"]) != "Yes")
                {
                    ...
                    {
                        checkexistpageright("Phlebotomist2wayAccept.aspx");
                    }
                }
                ViewState["regno"] = "";
    ...
    public void FillGrid()
    {
        try
        {
            ...
            if (txtbarcodeNo.Text.Trim() != "")
            {
               ...
               // var myString = "&2014";
                 NewBarcode = NewBarcode.Substring(2); 
            }
            if (txtOutbarcodeNo.Text.Trim() != "")
            {
                OutNewBarcode = txtOutbarcodeNo.Text.Trim();
               // var myString = "&2014";
                OutNewBarcode = OutNewBarcode.Substring(2); 
            }
            ...
            if (Convert.ToString(Session["UserType"]) == "Main Doctor" || Convert.ToString(Session["UserType"]) == "Technician" || Convert.ToString(Session["UserType"]) == "Reporting")
            {
                ...
                GV_Phlebotomist.DataSource = PatNB.Get_Phlebotomist_MainDoc_2Way(labcode, fromDate, toDate, patientName, Reg_no, Convert.ToInt32(Session["Branchid"]), Convert.ToString(Session["DigModule"]), "", 0, Session["UserName"].ToString(), Session["UserType"].ToString(), Center_Code, Barcode, NewBarcode, OutNewBarcode,PPID);
            }
            else
            {
                PatNB.AlterViewvw_VW_testmgr_nMain(fromDate, toDate);
                GV_Phlebotomist.DataSource = PatNB.Get_Phlebotomist_2Way(Center_Code, fromDate, toDate, patientName, Reg_no, Convert.ToInt32(Session["Branchid"]), Convert.ToString(Session["DigModule"]), "", 0, Session["UserName"].ToString(), Session["UserType"].ToString(), Barcode, txtmobileno.Text, NewBarcode, OutNewBarcode,PPID);
            }
            ...
            for (int i = 0; i < GV_Phlebotomist.Rows.Count; i++)
            {
                ...
                RadioButtonList RblAcceptRej = GV_Phlebotomist.Rows[i].FindControl("RblAcceptRej") as RadioButtonList;
                ...
                if (i > 0)
                {
                    if (GV_Phlebotomist.DataKeys[i].Value.ToString().Trim() == GV_Phlebotomist.DataKeys[i - 1].Value.ToString().Trim())
                    {
                        ...
                        GV_Phlebotomist.Rows[i].Cells[13].Text = "";
                        ...
                        if (ss == "2")
                        {
                            ...
                            RblAcceptRej.SelectedValue ="Reject";
                ...
                if ((GV_Phlebotomist.Rows[i].FindControl("hdnstatus") as HiddenField).Value == "1")
                {
                    try
                    {
                       ...
                       // RblAcceptRej.Enabled = false;
                        RblAcceptRej.ForeColor = System.Drawing.Color.Green;
                        RblAcceptRej.Enabled = false;
                ...
                if ((GV_Phlebotomist.Rows[i].FindControl("hdnstatus") as HiddenField).Value == "2")
                {
                    try
                    {
                       ...
                       // (GV_Phlebotomist.Rows[i].FindControl("rdreject") as RadioButton).Enabled = false;
                        RblAcceptRej.Enabled = false;
                        RblAcceptRej.ForeColor = System.Drawing.Color.Red;
                        GV_Phlebotomist.Rows[i].Cells[10].Enabled = false;
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    //ddloutsourceLab.Items.Insert(0, "-Inhouse Lab-");
        ...
        try
        {
            for (int i = 0; i < GV_Phlebotomist.Rows.Count; i++)
            {
                ...
                if (DelOk == (Button)sender)
                {
                    ...
                    TextBox txtrejectremarks = GV_Phlebotomist.Rows[i].FindControl("txtrejectremark") as TextBox;
                    string SpecimanRemark = (GV_Phlebotomist.Rows[i].FindControl("txtSpecimanRemarks") as TextBox).Text.ToString().Trim();
                    string ReqbyDoc = (GV_Phlebotomist.Rows[i].FindControl("txtReqbyDoc") as TextBox).Text.ToString().Trim();
                    string CenterCode = GV_Phlebotomist.Rows[i].Cells[5].Text;
                    ...
                    //  //-----  ObjBCC.UpdateIspheboAccept_TestWise(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 1, PID1, TestCodesT, Convert.ToString(Session["username"]),"");
                    ...
                    //else
                    //{
                    //    // ObjBCC.UpdateIspheboAccept(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 2, PID1);
                    //    ObjBCC.UpdateIspheboAccept_TestWise(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 2, PID1, TestCodesT, Convert.ToString(Session["username"]), txtrejectremarks.Text, SpecimanRemark, ReqbyDoc);
                    //}
                    ...
                    try
                    {
                        ...
                        //targetArr[0] = "1";
                        //featuresArr[0] = "";
                        //string TwoWayAccept="Yes";
                        //urlArr[0] = "BarcodePrint.aspx?PID=" + PID + "&Branchid=" + Session["Branchid"].ToString() + "&PatRegID=" + regNo + "&FID=" + FID + "&TestCode=" + TestCodesT + "&SampleType=" + sampletypeT + "&TwoWayAccept=" + TwoWayAccept + "";
    ...
    protected void GV_Phlebotomist_RowEditing1(object sender, GridViewEditEventArgs e)
    {
       ...
       DropDownList ddloutlab = GV_Phlebotomist.Rows[e.NewEditIndex].FindControl("ddloutsourceLab") as DropDownList;
        TextBox txtrejectremarks = GV_Phlebotomist.Rows[e.NewEditIndex].FindControl("txtrejectremark") as TextBox;
        RadioButtonList RblAcceptRej = GV_Phlebotomist.Rows[e.NewEditIndex].FindControl("RblAcceptRej") as RadioButtonList;
        ...
        if (RblAcceptRej.SelectedItem.Text == "Accept")
        {
            ...
            ObjTB.P_FormName = "Phlebotomist Accept 2 Way";
            ...
            if (ddloutlab.SelectedIndex > 0)
            {
                ...
                ObjTB.P_Patregno = Convert.ToString(regNo); ;
                ObjTB.P_FormName = "Phlebotomist Accept 2 Way";
                ObjTB.P_EventName = "Outsource Lab";
                ObjTB.P_UserName = Convert.ToString(Session["username"]);
                ObjTB.P_Branchid = Convert.ToInt32(Session["Branchid"]);
                ObjTB.Insert_DailyActivity();
        ...
        else
        {
            if (txtrejectremarks.Text == "")
            {
                ...
                txtrejectremarks.BackColor = System.Drawing.Color.Red;
            }
            else
            {
                ObjBCC.UpdateIspheboReject2way(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 2, PID1, TestCodesT, Convert.ToString(Session["username"]), txtrejectremarks.Text);
                ObjTB.P_Patregno = Convert.ToString(regNo); ;
                ObjTB.P_FormName = "Phlebotomist Accept 2 Way";
                ObjTB.P_EventName = "Sample Reject";
                ObjTB.P_UserName = Convert.ToString(Session["username"]);
                ObjTB.P_Branchid = Convert.ToInt32(Session["Branchid"]);
                ObjTB.Insert_DailyActivity();
                FillGrid();
    ...
    protected void GV_Phlebotomist_RowDeleting1(object sender, GridViewDeleteEventArgs e)
    {
        ...
        RadioButtonList RblAcceptRej = GV_Phlebotomist.Rows[e.RowIndex].FindControl("RblAcceptRej") as RadioButtonList;

       // if ((GV_Phlebotomist.Rows[e.RowIndex].FindControl("RblAcceptRej") as RadioButtonList).Checked == true)
            if (RblAcceptRej.SelectedItem.Text == "Accept")
             {

            // ObjBCC.UpdateIspheboAccept_TestWise(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 1, PID1, TestCodesT);
            // ObjBCC.UpdateIspheboAccept(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 1, PID1, Convert.ToString(Session["username"]));
            dtspe = ObjBCC.GetTestCodeSpecimanNo(Convert.ToString(PID), Convert.ToInt32(Session["Branchid"]));
            if (dtspe.Rows.Count > 0)
            {
                for (int i = 0; i < dtspe.Rows.Count; i++)
                {
                    ...
                    if (Convert.ToString(dtspe.Rows[i]["Patauthicante"]) == "Registered" && Convert.ToBoolean(dtspe.Rows[i]["Patrepstatus"]) == false)
                    {
                      //.....  ObjBCC.UpdateIspheboAccept_PrintAll(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 1, PID1, Convert.ToString(dtspe.Rows[i]["MTCode"]), Convert.ToString(Session["username"]));
                    }
                }
            }
            ...
            ObjTB.P_Patregno = Convert.ToString(regNo); ;
            ObjTB.P_FormName = "Phlebotomist Accept 2 Way";
            ObjTB.P_EventName = "Sample Accept and Print";
            ObjTB.P_UserName = Convert.ToString(Session["username"]);
            ObjTB.P_Branchid = Convert.ToInt32(Session["Branchid"]);
            ObjTB.Insert_DailyActivity();
        ...
        {
            //ObjBCC.UpdateIspheboAccept_TestWise(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 2, PID1, TestCodesT);
            ObjBCC.UpdateIspheboAccept(Convert.ToInt32(PID), Convert.ToInt32(Session["Branchid"]), 2, PID1, Convert.ToString(Session["username"]));
        }
        ...
        try
        {
            ...
            featuresArr[0] = "";
            string TwoWayAccept = "Yes";
            urlArr[0] = "BarcodePrint.aspx?PID=" + PID + "&Branchid=" + Session["Branchid"].ToString() + "&PatRegID=" + regNo + "&FID=" + FID + "&TwoWayAccept=" + TwoWayAccept + "";
            ResponseHelper.Redirect(urlArr, targetArr, featuresArr);
            FillGrid();
        }
        catch (Exception exc)
    ...
    protected void RblAcceptRej_SelectedIndexChanged(object sender, EventArgs e)
    {
        TextBox txtrejectremark = GV_Phlebotomist.Rows[0].FindControl("txtrejectremark") as TextBox;
        txtrejectremark.Visible = true;
        ImageButton btnemer = GV_Phlebotomist.Rows[0].FindControl("btnEmergency") as ImageButton;
        btnemer.Visible = false;
