 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestCytoResult.aspx.cs" Inherits="TestCytoResult" %>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Test Cyto Result</li>
                    </ol>
                </section>
                <!-- Main content -->
...
<script type="text/javascript" lang="javascript">    CKEDITOR.replace('<%=Editor1.ClientID%>');</script> 
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <label>Image1</label>                                
                                      ...
                                      <asp:button ID="Imgb12" runat="server" Text="Upload1"  onclick="Imgb1_Click"></asp:button>
                                ...
                                <asp:Image ID="Image1" runat="server" Height = "100" Width = "100" />
                                    ...
                                    <label>Image2</label>                               
                                      ...
                                      <asp:button ID="ImageButton1" 
                                              runat="server" Text="Upload2" onclick="ImageButton1_Click" ></asp:button>
...
<asp:Image ID="Image2" runat="server" Height = "100" Width = "100" />
                                    ...
                                    <label>Image3</label>
                                      ...
                                      <asp:button ID="ImageButton2" 
                                              runat="server" Text="Upload3" onclick="ImageButton2_Click" ></asp:button>
                                      </td>
                                       <td>
<asp:Image ID="Image3" runat="server" Height = "100" Width = "100" />
                                    ...
                                    <label>Image4</label>
                                      ...
                                      <asp:button ID="ImageButton3" 
                                              runat="server" Text="Uplaod4" onclick="ImageButton3_Click" ></asp:button>
                                      </td>
                                       <td>
<asp:Image ID="Image4" runat="server" Height = "100" Width = "100" />
                                    ...
                                    <label>Image5</label>
                                      ...
                                      <asp:button ID="ImageButton4" 
                                              runat="server" Text="Upload5" onclick="ImageButton4_Click" ></asp:button>
                                      </td>
                                       <td>
<asp:Image ID="Image5" runat="server" Height = "100" Width = "100" />
