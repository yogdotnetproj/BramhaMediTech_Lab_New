 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Formright.aspx.cs" Inherits="Formright" %>
   ...
   <asp:scriptmanager id="ScriptManager1" runat="server">
     ...
     <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                onselectednodechanged="TrMenu_SelectedNodeChanged" ForeColor="White" >
                                 ...
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="table-responsive" style="width:592px">
                                         <asp:GridView ID="GV_UserType"  class="table table-responsive table-sm table-bordered" runat="server" AutoGenerateColumns="False" DataKeyNames="SubMenuID"
                    Width="592px" OnPageIndexChanging="GV_UserType_PageIndexChanging" OnRowEditing="GV_UserType_RowEditing"
                    AllowPaging="True" PageSize="150" OnRowDeleting="GV_UserType_RowDeleting" 
                      HeaderStyle-ForeColor="Black"
  AlternatingRowStyle-BackColor="White" 
                      onrowdatabound="GV_UserType_RowDataBound" >
                    ...
                    <Columns>
                        <asp:BoundField DataField="MenuName" HeaderText="Menu Name" />
                         <asp:BoundField DataField="SubMenuName" HeaderText="Sub Menu Name" />
                          <asp:TemplateField HeaderText="isvisable">
                                <ItemTemplate>
                                    <asp:CheckBox ID="chkisvisable" runat="server" Width="70PX" AutoPostBack="True" 
                                        oncheckedchanged="chkisvisable_CheckedChanged"   ></asp:CheckBox>
                                     <asp:Label ID="lblisvisable" Text='<%#Bind("Isvisable")%>' Visible="false"  runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        <asp:CommandField HeaderText="Edit " ShowEditButton="True" Visible="false" EditImageUrl="~/Images/edit.gif"
                            ButtonType="Image" />
                    </Columns>
