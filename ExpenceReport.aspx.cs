...
public partial class ExpenceReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            try
            {
                ...
                {
                    checkexistpageright("ExpenceReport.aspx");
                }
                Binddropdown();
    ...
    protected void btndailytrans_Click(object sender, EventArgs e)
    {
        ...
        Session["rptname"] = Server.MapPath("~/DiagnosticReport/Rpt_ExpenceReport.rpt");
        Session["reportname"] = "ExpenceReport";
