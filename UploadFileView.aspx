<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadFileView.aspx.cs" Inherits="UploadFileView" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
 <Maintestname>File View</Maintestname>
        ...
        <table width="1000px"    >
            ...
            <tr>              
                <td >
                  ...
                  <asp:HyperLink ID="Hyp_viewPres" runat="server" >View Pres</asp:HyperLink>
                </td>
            </tr>
