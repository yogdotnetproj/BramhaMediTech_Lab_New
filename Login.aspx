                       ...
                       <!-- <input type="email" class="form-control" placeholder="Email"> -->
                        ...
                        <asp:TextBox ID="txtUName" runat="server" class="form-control"></asp:TextBox>
                            ...
                            <asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server"
                                    controltovalidate="txtUName" display="Dynamic" errormessage="*" setfocusonerror="True" validationgroup="loginGroup"></asp:requiredfieldvalidator>
                      ...
                      <!--  <input type="password" class="form-control" placeholder="Password">-->
                        ...
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span <asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server"
                           ...
                           <!-- <button type="submit" class="btn btn-primary btn-block btn-flat">Login</button> -->
                             ...
                             <asp:button id="btnLogin" runat="server" class="btn btn-primary mt-3"  OnClick="btnLogin_Click"
