<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="DrWise_StatisticsReport.aspx.cs" Inherits="DrWise_StatisticsReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="d-flex justify-content-between content-header mb-2">
                    <h4>Dr Wise Statistics Report </h4>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Home.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
                    <li class="breadcrumb-item active">Dr Wise Statistics Report </li> 
                    </ol>
                </section>
                <!-- Main content -->
