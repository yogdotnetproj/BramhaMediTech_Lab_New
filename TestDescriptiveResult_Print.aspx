 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestDescriptiveResult_Print.aspx.cs" Inherits="TestDescriptiveResult_Print" %>
     ...
     <div class="wrapper">
            ...
            <asp:Label ID="Label1" runat="server" Text=" " Width="51px" Font-Bold="True"></asp:Label>
                              ...
                              &nbsp;
                                    ...
                                    <td align="center">
                                    <label> </label>
                                    <asp:UpdatePanel ID="DP" runat="server">
                                    <ContentTemplate>
                                    
                                  <asp:TextBox ID="Editor1" runat="server" Height="400px" Style="text-indent: 2px"  Width="600px" ></asp:TextBox>
                                      <cc:HtmlEditor ID="Editor" runat="server" Height="400px" Style="text-indent: 2px"  Width="600px" />
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                                      </td>
                                      </tr>
