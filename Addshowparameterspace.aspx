 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Hospital.master" CodeFile="Addshowparameterspace.aspx.cs" Inherits="Addshowparameterspace" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
            ...
            <!-- Content Wrapper. Contains page content -->
                ...
                <section class="content-header">
                    <h1>Add / Edit Test Parameter</h1>
                    <ol class="breadcrumb">
                   
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Add / Edit Test Parameter</li>
                    </ol>
                </section>
                <!-- Main content -->
                    ...
                    Width="189px"></asp:RequiredFieldValidator>--%>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txttestorder" runat="server" class="form-control" placeholder="Parameter Order" ReadOnly="True"></asp:TextBox><span style="color:Red;">*</span>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txttestorder"
                    ErrorMessage="Order no is Required ." ValidationGroup="form" Width="214px"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
