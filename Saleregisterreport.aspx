 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="Saleregisterreport.aspx.cs" Inherits="Saleregisterreport" %>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <li><a href="Login.aspx"><i class="fa fa-fw fa-power-off"></i> Log out</a></li>
                        ...
                        <li class="active">Sale Register </li>
                    </ol>
                </section>
                <!-- Main content -->
                ...
                <cc1:AutoCompleteExtender id="AutoCompleteExtender2" runat="server"  CompletionListCssClass="AutoExtender"
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight" CompletionListElementID="Div2" ServiceMethod="GetCenterName" TargetControlID="txtCenter" MinimumPrefixLength="1">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                          ...
                                          <asp:TextBox ID="txtDoctorName" placeholder="Enter Doctor Name"  runat="server"  class="form-control" ontextchanged="txtDoctorName_TextChanged"
                            ...
                            <div class="row">
                                <div class="col-lg-12 text-center">
                                     ...
                                     <asp:button id="btnlist" runat="server" OnClientClick="return validate();" onclick="btnlist_Click"
                                            ...
                                            tooltip="Sale register Report" Text="Sale register Report"
                                            />
  ...
  AlternatingRowStyle-BackColor="White"   autogeneratecolumns="False" PageSize="25"
                    ...
                    <columns>
                            ...
                            <asp:BoundField DataField="BillDate" HeaderText="Date" />
                              <asp:BoundField DataField="BillTime" HeaderText="Bill Time" />
                            ...
                            <asp:BoundField DataField="PatientPhoneNo" HeaderText="Phone No" />
                             ...
                             <asp:BoundField DataField="BillNo" HeaderText="Bill No" />
                              <asp:BoundField DataField="NetPayment" HeaderText=" Amount" />
                              ...
                              <asp:BoundField DataField="TaxAmount" HeaderText="Tax" />
                               ...
                               <asp:BoundField DataField="DocName" HeaderText="Dr.Name" />
