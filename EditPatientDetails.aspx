 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPatientDetails.aspx.cs" Inherits="EditPatientDetails" %>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                        ...
                        <asp:BoundField HeaderText="Reg No" DataField="PatRegID" />
                         ...
                         <asp:BoundField HeaderText="Reg Date" DataField="Patregdate" />
                           <asp:BoundField HeaderText="Test Status" DataField="MTCode" />
                            <asp:BoundField HeaderText="Test Name" DataField="Maintestname" />
                            
                            <asp:TemplateField HeaderText="Amount">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtamount" runat="server" Enabled="false" Width="70PX" Text='<%#Bind("TestRate")%>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Cancel">
                              ...
                              <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                   ...
                                   <asp:HiddenField ID="hdn_TestDeActive" runat="server" Value='<%#Eval("TestDeActive") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
