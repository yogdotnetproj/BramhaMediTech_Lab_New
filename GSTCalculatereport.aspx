 <%@ Page Language="C#" AutoEventWireup="true" CodeFile="GSTCalculatereport.aspx.cs" Inherits="GSTCalculatereport" %>
...
<body class="hold-transition skin-black sidebar-mini">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <li><a href="Login.aspx"><i class="fa fa-fw fa-power-off"></i> Log out</a></li>
                        ...
                        <li class="active">Tax Calculate </li>
                    </ol>
                </section>
                <!-- Main content -->
 ...
 <asp:button id="btnlist" runat="server" OnClientClick="return validate();" class="btn btn-primary" onclick="btnlist_Click" text="Click"   />
 <asp:button id="btnreport1" OnClientClick="return validate();" runat="server"  onclick="btnreport1_Click"  tooltip="Tax Calc Report" Text="Tax Calc  Report" class="btn btn-primary" />
                                </div> 
                            </div>
                        </div>
                    </div>
    ...
    <asp:gridview id="GV_TaxCalc" runat="server" class="table table-responsive table-sm table-bordered"  width="100%" onrowdatabound="GV_TaxCalc_RowDataBound"
                    onrowediting="GV_TaxCalc_RowEditing"   HeaderStyle-ForeColor="Black"
  AlternatingRowStyle-BackColor="White"   autogeneratecolumns="False" PageSize="25"
                    allowpaging="True" onpageindexchanging="GV_TaxCalc_PageIndexChanging">
                    <columns>
                           
                            <asp:BoundField DataField="Bill_No" HeaderText="Bill No" />
                              <asp:BoundField DataField="Customer_Name" HeaderText="Customer Name" />
                               <asp:BoundField DataField="Customer_PanNumber" HeaderText=" Customer PanNumber" />   
                             ...
                             <asp:BoundField DataField="Amount" HeaderText="Amount" />
                              ...
                              <asp:BoundField DataField="Discount" HeaderText="Discount" />
                               ...
                               <asp:BoundField DataField="Tax_Amount" HeaderText=" Tax Amount" />
                                <asp:BoundField DataField="Is_Printed" HeaderText="Is Printed" />
