 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Hospital.master" CodeFile="ShowAppoinmentBookedPatient.aspx.cs" Inherits="ShowAppoinmentBookedPatient" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
     ...
     <asp:scriptmanager id="ScriptManager1" runat="server">
                ...
                <section class="content-header">
                    <h1>Show Appoinment Booked Patient</h1>
                    <ol class="breadcrumb">
                   
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Show Appoinment Booked Patient</li>
                    </ol>
                </section>
                <!-- Main content -->
    ...
    <asp:ListItem>Done</asp:ListItem>
      ...
      <asp:ListItem Selected="True">Not Done</asp:ListItem>
                    ...
                    Text="Click" TabIndex="7" onclick="btnclick_Click" />
                                     <asp:Button ID="btnreport" runat="server"  class="btn btn-primary" 
...
<asp:BoundField DataField="DirectApp" HeaderText="Direct Appoint" />
<asp:CommandField EditText="Attend" Visible="false" ItemStyle-ForeColor="Black" HeaderText="Action"  ShowEditButton="True" />
