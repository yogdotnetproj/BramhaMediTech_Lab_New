...
public partial class Testresultentry : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (Pat_Regid != "")
            {
                ...
                if (Session["Type"] != null)
                {
                    ...
                    {
                        (e.Row.Cells[0].Controls[0] as HyperLink).NavigateUrl = "Addresult.aspx?PatRegID=" + Pat_Regid + "&FID=" + FID + "&RepType=TestResultEntryCyto" + "&Maindept=" + hdnMaindept + "&Amend=NO";

                    }
                    else if (Session["Type"].ToString() == "Histo")
                    {
                        (e.Row.Cells[0].Controls[0] as HyperLink).NavigateUrl = "Addresult.aspx?PatRegID=" + Pat_Regid + "&FID=" + FID + "&RepType=TestResultEntryHisto" + "&Maindept=" + hdnMaindept + "&Amend=NO";

                    }
                    else
                    {
                        (e.Row.Cells[0].Controls[0] as HyperLink).NavigateUrl = "Addresult.aspx?PatRegID=" + Pat_Regid + "&FID=" + FID + "&RepType=TestResultEntry" + "&Maindept=" + hdnMaindept + "&CN=" + CenterCodeNew + "&TS=" + status + "&FrDate=" + fromdate.Text + "&ToDate=" + todate.Text + "&DeptName=" + txttestname.Text + "&EDate=" + PEDate + "&pname=" + txtPatientName.Text + "&sid=" + txtregno.Text.Trim() + "&Amend=NO";
                ...
                else
                {
                   ...
                   // (e.Row.Cells[0].Controls[0] as HyperLink).NavigateUrl = "Addresult.aspx?PatRegID=" + Pat_Regid + "&FID=" + FID + "&RepType=TestResultEntry" + "&Maindept=" + hdnMaindept + "&CN=" + CenterCodeNew + "&TS=" + status + "&FrDate=" + fromdate.Text + "&ToDate=" + todate.Text + "&EDate=" + PEDate;
                    (e.Row.Cells[10].Controls[0] as HyperLink).NavigateUrl = "Addresult.aspx?PatRegID=" + Pat_Regid + "&FID=" + FID + "&RepType=TestResultEntry" + "&Maindept=" + hdnMaindept + "&CN=" + CenterCodeNew + "&TS=" + status + "&FrDate=" + fromdate.Text + "&ToDate=" + todate.Text + "&EDate=" + PEDate + "&TestCode=" + hdn_MTcode + "&pname=" + txtPatientName.Text + "&sid=" + txtregno.Text.Trim() + "&Amend=NO";
    ...
    void BindGrid()
    {
        ...
        { 
            ...
            else
            {
                ...
                {
                    dt = Patmst_New_Bal_C.GetPatmstForTeamL_new_11_testwise(labCode, "0", fromDate, toDate, status, MTCode, patientName, Pat_Regid, BarcodeID, CenterCode, Session["UserName"].ToString(), Session["UserType"].ToString(), Convert.ToInt32(Session["Branchid"]), Convert.ToInt32(Session["DigModule"]), 0, txttestname.Text, Mno, CenterCodeNew, RepDoneBy);
                }
