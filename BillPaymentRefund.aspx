<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="BillPaymentRefund.aspx.cs" Inherits="BillPaymentRefund" %>
     ...
     <asp:scriptmanager id="ScriptManager1" runat="server">
            ...
            <!-- Content Wrapper. Contains page content -->
                ...
                <section class="content-header">
                    <h1>Bill Payment Refund</h1>
                    <ol class="breadcrumb">
                    
                       
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Bill Payment Refund </li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                 ...
                 <asp:textbox id="txtname" runat="server" placeholder="EnterName" class="form-control" tabindex="3">
                </asp:textbox>
                                    </div>
                                </div>
                 ...
                 <asp:textbox id="txtregno" runat="server" class="form-control"  placeholder="Enter Reg No" tabindex="4">
                </asp:textbox>
                                    </div>
                                </div>
                                </div>
                ...
                <asp:gridview id="GV_Billcancel" class="table table-responsive table-sm table-bordered" datakeynames="PID" runat="server" width="100%" autogeneratecolumns="False"
                    allowsorting="True" onrowediting="GV_Billcancel_RowEditing" allowpaging="True" onpageindexchanging="GV_Billcancel_PageIndexChanging"
                    pagesize="20"   HeaderStyle-ForeColor="Black"
  AlternatingRowStyle-BackColor="White"   onrowdeleting="GV_Billcancel_RowDeleting" OnRowDataBound="GV_Billcancel_RowDataBound">
                    ...
                    <columns>
                     <asp:BoundField DataField="Patregdate" HeaderText="Date " />
                        ...
                        <asp:TemplateField HeaderText="Amt Paid" >
                                <ItemTemplate>
                                    <asp:Label ID="lblAmtPAid" Text='<%#Bind("AmtPaid")%>' runat="server"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                          ...
                          <asp:TemplateField HeaderText="Refund" >
                                                    <ItemTemplate  >
                                                        <asp:TextBox id="txtRefundAmt" runat="server" ></asp:TextBox>
                                                        </ItemTemplate>
                              </asp:TemplateField>
                         <asp:TemplateField HeaderText="Action" >
                                                    <ItemTemplate  >
                                                        <asp:ImageButton ID="btndescresult" runat="server" ToolTip="Refund Amt"  OnClientClick="return ValidateDelete();" CommandArguement='<%#Eval("PatRegID")%>'  ImageUrl="~/Images0/delete.gif" 
                             ...
                             <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:HiddenField ID="hdnCollcode" runat="server" Value='<%#Bind("CenterCode")%>' />
                                     ...
                                     <asp:HiddenField ID="hdnPID" runat="server" Value='<%#Bind("PID")%>' />
                                </ItemTemplate>
                                <ItemStyle Width="0px" />
                            </asp:TemplateField>
                        </columns>
             ...
             function OpenReport() {
                ...
                <script language="javascript" type="text/javascript">
                    function ValidateDelete() {
                        var Check = confirm('Are you sure you want to Refund this Amt ?')
                        if (Check == true) {
                            return true;
                        }
                        else {
