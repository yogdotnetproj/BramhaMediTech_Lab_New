 <%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Hospital.master"  CodeFile="TestwiseDailyPayment.aspx.cs" Inherits="TestwiseDailyPayment" %>
     ...
     <asp:scriptmanager id="ScriptManager1" runat="server">
            ...
            <!-- Content Wrapper. Contains page content -->
                ...
                <section class="d-flex justify-content-between content-header mb-2">
                    <h4>Test wise Daily Perform Rate</h4>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Home.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
                    <li class="breadcrumb-item active">Test wise Daily Perform Rate</li> 
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
                    ...
                    <cc1:AutoCompleteExtender ID="AutoCompleteExtender3" runat="server" MinimumPrefixLength="1"
                        ...
                        </div>            <asp:Label ID="Label4" runat="server" Text="" Font-Bold="true" ForeColor="red" style="display:none" >  </asp:Label >
                         ...
                         <asp:BoundField HeaderText="Rate Type" DataField="RateType" />
                            ...
                            <asp:TemplateField HeaderText="Amount">
                             ...
                             <asp:TemplateField HeaderText="Amount Per (%)">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtamountPer" runat="server" Width="70PX" Text='<%#Bind("Percentage")%>'></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
