...
public partial class TestCytoResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                OBjTDR.TestDescriptiveResult_bCyro(PatRegID, fid, MTCode, Convert.ToInt32(Session["Branchid"]));
                if (OBjTDR.TextDesc != "")
                {
                ...
                PatSt_Bal_C PatSt = new PatSt_Bal_C(PatRegID.ToString().Trim(), fid, T_Code, 0, Convert.ToInt32(Session["Branchid"]));

                if (PatSt.Patauthicante == "Authorized")
                {
    ...
    {
        DataTable dt = new DataTable();
        TestDescriptiveResult_b Obj_TDR = new TestDescriptiveResult_b();

        dt = Obj_TDR.getDefaultResults_search_Cyto(MTCode, Convert.ToInt32(Session["Branchid"]), txtFormatName.Text);
    ...
    protected void CmbFormatName_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (CmbFormatName.SelectedValue != "")
        {
            ...
            Editor1.Text = new Dfrmst_Bal_C(T_Code, CmbFormatName.SelectedValue,Convert.ToInt32(Request.QueryString["subdeptid"])).Result.Replace("#FFFFFF", "#000000").Replace("#ffffff", "#000000");
           // txtTestcode.Text = new Dfrmst_Bal_C(T_Code, CmbFormatName.SelectedValue,0).Name;
            txtTestcode.Text = CmbFormatName.SelectedItem.Text;
    ...
    protected void cmdSaveClose_Click(object sender, EventArgs e)
    {
        ...
        dtexistaut = Obj_Patst.Check_Authorised_Test(lblRegNo.Text, Obj_MTB_C.MTCode, Convert.ToInt32(Session["Branchid"]), Convert.ToString(Request.QueryString["FID"]));
       ...
       // Obj_PBC.P_Technicanby = Session["username"].ToString();
        ...
        try
        {
             ...
             OBjTDR.TestDescriptiveResult_bCyro(PatRegID, fid, Obj_MTB_C.MTCode, Convert.ToInt32(Session["Branchid"]));
           ...
           // OBjTDR.TextDesc = OBjTDR.TextDesc.Replace("<p style=\"text-align:center\">", "<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
            ...
            OBjTDR.update_Cyto(Convert.ToInt32(Session["Branchid"]));
        }
        catch
        {
          ...
          //  Obj_TDR_C.TextDesc = Obj_TDR_C.TextDesc.Replace("<p style=\"text-align:center\">", "<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
           ...
           // Obj_TDR_C.Insert_Cyto(Convert.ToInt32(Session["Branchid"]));
           
             Patmst_Bal_C ObjPatmst = new Patmst_Bal_C();
             if (ObjPatmst.getallreadyRegister_RadMst_Cyto(Obj_TDR_C.PatRegID, Obj_TDR_C.MTCode))
             {
                 sc = new SqlCommand("" +
        ...
        Response.Redirect("Addresult.aspx?PatRegID=" + Request.QueryString["PatRegID"] + "&fid=" + Request.QueryString["fid"] + "&RepType=CytoReport");
    ...
    protected void cmdClear_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            Dfrmst_Bal_C Dfrmst = new Dfrmst_Bal_C(T_Code, txtTestcode.Text,0);
            ...
            if (CmbFormatName.Text != "")
                Dfrmst.update_Cyto(CmbFormatName.Text, Convert.ToInt32(Session["Branchid"]));
            else
                Dfrmst.update_Cyto(txtTestcode.Text, Convert.ToInt32(Session["Branchid"]));
        ...
        catch
        {
            ...
            Dfrmst.Insert_Cyto(Convert.ToInt32(Session["Branchid"]));
        }
    }
