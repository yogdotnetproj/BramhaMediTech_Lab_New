...
public partial class NewPrintreport :BasePage
{
    ...
    void BindGrid()
    {
        ...
        for (int i = 0; i < gridreport.Rows.Count; i++)
        {
            ...
            {
                gridreport.Rows[i].Cells[09].Text = "<span class='btn btn-xs btn-Blue' >Registered</span>";
                gridreport.Rows[i].Cells[10].Text = "";
            }
            ...
            {
                gridreport.Rows[i].Cells[09].Text = "<span class='btn btn-xs btn-danger' >Tested</span>";
                gridreport.Rows[i].Cells[10].Text = "";
            }
            else
            {
