 <%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Hospital.master" CodeFile="Phlebotomist.aspx.cs" Inherits="Phlebotomist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <section class="d-flex justify-content-between content-header mb-2">
                    <h4>Phlebotomist / Sample Collection (Barcoding)</h4>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Home.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
                    <li class="breadcrumb-item active">Phlebotomist / Sample Collection (Barcoding)</li> 
                    </ol>
                </section>
                <!-- Main content -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                         ...
                                         <asp:TextBox ID="txtregno" placeholder="Enter Registration number"  runat="server"  class="form-control pull-right" TabIndex="5">
                </asp:TextBox>
                                    </div>
                                </div>  
                                 <div class="col-sm-2">
                                    <div class="form-group">
                                         ...
                                         <asp:TextBox ID="txtPPID" placeholder="Enter PPID number"  runat="server"  class="form-control pull-right" TabIndex="5">
                </asp:TextBox>
                                    </div>
                                </div>  
                                <div class="col-sm-2">
 ...
 OnPageIndexChanging="GV_Phlebotomist_PageIndexChanging"
                    PageSize="50" AllowPaging="true" OnRowEditing="GV_Phlebotomist_RowEditing1" OnRowDeleting="GV_Phlebotomist_RowDeleting1"
...
<PagerSettings Visible="true"></PagerSettings>
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="BarCode">
                            <ItemTemplate>
                                <asp:TextBox ID="txtBarcodeid" runat="server" class="form-control" BorderColor="#0099cc" Width="70px"  Text='<%#Eval("BarcodeID") %>' ></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Accept/Reject" Visible="false" >
                           
                            <ItemTemplate>
                                <asp:RadioButton ID="rdaccept" runat="server" ProfileName="status"  
                                    Text="Accept" AutoPostBack="true" Checked="True" oncheckedchanged="rdaccept_CheckedChanged" />
                                <asp:RadioButton ID="rdreject" runat="server" ProfileName="status" Text="Reject" CommandName="Reject"
                                    CommandArgument='<%#Eval("STCODE")%>' />
                        ...
                        <asp:CommandField ButtonType="Button" DeleteText=" Print" HeaderText="Print All"
                         ...
                         <asp:TemplateField HeaderText="Outsource Lab" Visible="false" >
                        ...
                        <asp:BoundField DataField="PhlebotomistRejectremark" ItemStyle-ForeColor="Red" HeaderText="Reject Remark" SortExpression="PhlebotomistRejectremark" >
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnstatus" runat="server" Value='<%#Eval("PhlebotomistCollect") %>' />
