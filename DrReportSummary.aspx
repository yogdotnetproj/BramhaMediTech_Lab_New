<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="DrReportSummary.aspx.cs" Inherits="DrReportSummary" %>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <cc1:AutoCompleteExtender id="AutoCompleteExtender1" runat="server"  CompletionListCssClass="AutoExtender"
                                            ...
                                            CompletionListHighlightedItemCssClass="AutoExtenderHighlight" CompletionListElementID="div" TargetControlID="txtdoctor" ServiceMethod="FillDoctor" MinimumPrefixLength="1"></cc1:AutoCompleteExtender>
