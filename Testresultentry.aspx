<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="Testresultentry.aspx.cs" Inherits="Testresultentry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <section class="d-flex justify-content-between content-header mb-2">
                    <h4>Test Result Entry</h4>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Home.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
                    <li class="breadcrumb-item active">Test Result Entry</li> 
                    </ol>
                </section>
                <!-- Main content -->
...
<asp:Label ID="lblpcount" runat="server" Font-Bold="true" ForeColor="black" Text=""></asp:Label>
 ...
 onrowediting="GVTestentry_RowEditing" onselectedindexchanged="GVTestentry_SelectedIndexChanged"  OnRowCommand="GVTestentry_RowCommand">
                                ...
                                <asp:HyperLinkField HeaderText="Submit" Text="Submit"  DataNavigateUrlFields="PatRegID,FID,SampleStatusNew,CenterCode" DataNavigateUrlFormatString="Addresult.aspx?PatRegID={0}&amp;FID={1}&amp;CN={3}&amp;TS={2}" />
