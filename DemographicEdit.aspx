<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital.master" AutoEventWireup="true" CodeFile="DemographicEdit.aspx.cs" Inherits="DemographicEdit" %>
   ...
   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <section class="d-flex justify-content-between content-header mb-2">
                    <h4>Clinical History Edit</h4>
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="Home.aspx"><i class="fa fa-dashboard"></i> Home</a></li> 
                    <li class="breadcrumb-item active">Clinical History Edit</li> 
                    </ol>
                </section>
                <!-- Main content -->
...
<cc1:AutoCompleteExtender id="AutoCompleteExtender2" runat="server" MinimumPrefixLength="1"
 ...
 AutoPostBack="false"></asp:TextBox>  
                                ...
                                <div class="col-sm-2 text-center">
                                                   <asp:button id="btnshow" runat="server" class="btn btn-success" OnClientClick="return validate();"  onclick="btnshow_Click" text="Submit"  />
